...
export default async function SkateBoard({ id }: Props) {
  ...
  return (
    <div className="group relative mx-auto w-full max-w-72 px-8 pt-4">
      ...
      <div className="flex items-center justify-between ~text-xl/2xl">
        <span>{price}</span>
      ...
      <div className="-mb-1 overflow-hidden py-4">
        ...
        <PrismicNextImage
          ...
          alt=""
          width={150}
          className="druation-500 mx-auto w-[58%] origin-top transform-gpu transition-transform ease-in-out group-hover:scale-150"
        />
      </div>

      <HorizontalLine className={HORIZONTAL_LINE_CLASSES} />

      <h3 className="my-2 text-center font-sans leading-tight ~text-xl/2xl">
        {product.data.name}
      </h3>
